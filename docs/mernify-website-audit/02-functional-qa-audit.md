...
| Email in footer | **Not present** | ❌ Fail | `hello@mernify.com` only on contact page |
...
| Error state | "Something went wrong. Please email hello@mernify.com." | ✅ Code | |
...
| `hello@mernify.com` mailto link | ✅ Pass | Present in meta list |
...
| `hello@mernify.com` | ✅ Present | Contact page only |
...
| `hello@mernify.com` not verified operational | Contact | P1 |
